            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
           	   ...
           	   <div class="form-group row">
              		...
              		<div class="col-sm-3">
                   		<input id="e_date" type="date" name = "e_date" class="form-control">
              		</div>
                    ...
                    <div class="form-group">
                      <div class="form-group row">
                          <label class="col-sm-1 control-label">state:</label>
                            <div class="col-sm-2">
                              <select name="e_state" type="text" class="form-control" style="padding:0;">
              			<option value="" selected="selected"></option> 
              		    ...
              		    <div class="col-sm-2">
                  		<input type="text" name = "e_zipcode" class="form-control" style="padding:5px;" >
              		    </div>
