...
<div class="row" style="margin-top:50px; font-size:25px; ">
		...
		<div class="col-md-10 event-stuff" style="color:white;padding:0 26px;">
			...
			<div class="col-md-6" style="background:<?php echo $style[$category]['theme-color-1']?>; padding:17px; text-align:center;">
                            <!--name of event-->
                        ...
                        <div class="col-md-6" style="text-align:center;margin-top:10px;">              	
                            <div class="row" style="color:white;">
                                ...
                                <?php if($event[0]['e_is_ticketed']) {?>
                                	<a href="#" data-toggle="modal" data-target="#largeModal" class="btn viewmorewrevs" style="border-radius:10px;font-size:23px;color:white;">Buy Tickets</a>
                                <?php }?>
			   ...
			   <div style="margin-top:50px;">
			    ...
			    <?php if(!$event[0]['e_is_address_hide']) {?>
                    ...
                    <div class="row" style="margin-top:50px;">	
                    	<div class="col-md-6" style="border-right-style: solid;	border-right-color: gray;border-right-width: thin;">
