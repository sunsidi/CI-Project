...
<div id='sentMessage'><?php if ($this->session->flashdata('message')) echo '<p id="sentStyle" style="margin-left:auto;margin-right:auto; margin-top:20px;width: 500px; background-color:#4EA48B; color: white;text-align:center;font-size:20px;">'.$this->session->flashdata('message').'</p>';?></div>
  ...
  <?php if(isset($_POST['submit'])){ ?><p id="alertMessage" style="margin-left:auto;margin-right:auto; margin-top:20px;width: 40%; background-color:#4EA48B; color: white;text-align:center;font-size:20px;">Cancellation request received.<br> We will review it and get back to you soon.</p> <?php } ?>
		...
		<div class="col-md-3 col-md-offset-1">
        	<div class="panel panel-default" style="border:none;">
  				...
  				<div class="panel-body" style="background:#DDE0E7;">
                    ...
                    <a href="<? echo base_url()?>account/myaccount_eventattending" style="color:#628DA3;"><button type="button" class="btn btn-lg btn-block account">Events I&rsquo;m Attending</button></a>
					...
					<a href="<? echo base_url()?>account/myaccount_stats"><button type="button" class="btn btn-lg btn-block account-active">Statistics and Analysis</button></a>
  				</div>
			</div>           
        </div>
        <div class="col-md-7">
										...
										<div class="panel stat-panel">
											<div class="panel-body" style="padding:5px;">
												...
												<div class="tab-content">
													...
													<div><div class="box" style="background:#ADE7F1;"></div> &nbsp;&nbsp; Early Bird</div>
												</div>	
											</div>
										</div>
									</div>
												...
												<div class="tab-content">
													<div class="tab-pane active" id="total-tickets-age">
														<div>
															...
															<canvas id="total_age">-->
															<div><div class="box" style="background:#F65660;"></div> &nbsp;&nbsp; Under 18</div>
															<div><div class="box" style="background:#3BC0BD;"></div> &nbsp;&nbsp; 18-25</div>
															<div><div class="box" style="background:#60AAE1;"></div> &nbsp;&nbsp; 26-35</div>
															<div><div class="box" style="background:#E08AC8;"></div> &nbsp;&nbsp; Over 35</div>
															<div><div class="box" style="background:#FAB36B;"></div> &nbsp;&nbsp; Unspecified</div>
														</div>
														<div style="margin-top:30px;">
															<p style="text-align:center;">Gender</p>
															<!--Should be showing up but doesn't
															<canvas id="total_gender"/>-->
															<div><div class="box" style="background:#F65660;"></div> &nbsp;&nbsp; Man</div>
															<div><div class="box" style="background:#FAB36B;"></div> &nbsp;&nbsp; Woman</div>
															<div><div class="box" style="background:#3BC0BD;"></div> &nbsp;&nbsp; Transgender</div>
															<div><div class="box" style="background:#E08AC8;"></div> &nbsp;&nbsp; Unspecified</div>
														</div>
										...
										<div class="panel-body">
											...
											<div class="tab-content">
												<div class="tab-pane active" id="total-tickets">
													...
													<div style="margin-top:30px;">
														<p style="text-align:center;"><strong>Tickets Returned: 5</strong></p>
										...
										<div class="panel stat-panel">
											<div class="panel-body" style="padding:5px;">
												...
												<div class="tab-content">
													...
													<div><div class="box" style="background:#FBE6CC;"></div> &nbsp;&nbsp; Hits</div>
													<div><div class="box" style="background:#FBCBCC;"></div> &nbsp;&nbsp; Number of Visits</div>
													<div><div class="box" style="background:#ADE7F1;"></div> &nbsp;&nbsp; Unique Visitor</div>
												</div>	
											</div>
										</div>
									</div>
										...
										<div class="panel-body">
											...
											<div class="tab-content">
												<div class="tab-pane active" id="total-visits">
													...
													<div style="margin-top:30px;">
														<p style="text-align:center;"><strong>Visitors Who Declined: 5</strong></p>
														<canvas id="total_tickets_returned_doughnut"/>
													</div>
