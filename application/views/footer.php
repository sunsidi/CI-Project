...
<!--footer
==================================================-->
 <div id="footer navbar-fixed-bottom"  style="background:#A5B9CB;bottom: 0;">
      <div class="row" style="padding:20px;">	
		<div class="col-md-4" style="text-align:center;margin-top:10px;">
			<img src="<?php echo $PATH_IMG?>wrevel_logo.png" alt="Wrevel logo" style="width:207px;"/>
			<p style="font-size:25px; margin-top:10px;color:white;">
				<a href="https://www.facebook.com/wrevelinc" target="_blank" style="color:white;"><i class="fa fa-facebook" style="padding:20px 15px;"></i></a>
				<a href="https://twitter.com/wrevelco" target="_blank" style="color:white;"><i class="fa fa-twitter" style="padding:20px 15px;"></i></a>
				<a href="http://instagram.com/wrevel" target="_blank" style="color:white;"><i class="fa fa-instagram" style="padding:20px 15px;"></i></a>
				<a href="http://wrevel.tumblr.com" target="_blank" style="color:white;"><i class="fa fa-tumblr" style="padding:20px 15px;"></i></a>
				<a href="http://www.youtube.com/wrevelinc" target="_blank" style="color:white;"><i class="fa fa-youtube" style="padding:20px 15px;"></i></a>
			</p>
		...
		<div class="aceg">
			...
			<ul class="links">
				...
				<li><a href="<?php echo base_url().'info/ticketing_platform'?>">Our Ticketing Platform</a></li>
				<li><a href="<?php echo base_url().'info/pricing'?>">Pricing</a></li>
				<li><a href="<?php echo base_url().'info/FAQ'?>">F.A.Q.</a></li>
				<li><a href="<?php echo base_url().'info/media'?>">Stories</a></li>
				<li><a href="<?php echo base_url().'gallery/ny_tech_day'?>">Gallery</a></li>
			</ul>
			</div>
			<div class="col-md-4">
			<ul class="links">
