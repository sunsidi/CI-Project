...
<title>My Account - My Event Listings | Wrevel - Discover Your World, Host & Experience Events</title>
...
<!--content
==============================================-->
<div id='sentMessage'><?php if ($this->session->flashdata('message')) echo '<p id="sentStyle" style="margin-left:auto;margin-right:auto; margin-top:80px;width: 40%; background-color:#4EA48B; color: white;text-align:center;font-size:20px;">'.$this->session->flashdata('message').'</p>';?></div>  <div class="container" style="padding-bottom:50px;">
	...
	<div class="row" style="margin-top:110px;">
        ...
        <div class="col-md-7" id="myaccount-step2">
        	<div class="row">
