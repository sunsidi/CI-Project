...
<h1 style="text-align:center;font-size:40px;font-family:GillSans;color:white;"><img src="<?php echo $PATH_IMG?>w1.png"/>Pricing</h1>
    <!--Gazette-->   
		...
		<div class="col-md-6" style="background: #4a97c9; border-radius: 10px; margin-top: 30px;">
		<p style="line-height: 0px;text-align: center;color: white; font-size: 27px; padding-top: 70px;"><img src="<?php echo $PATH_IMG?>pig.png"/>  <b>Simple payment system</b></p><br/>
		...
		<p style="line-height: 0px;text-align: left;margin-left:15%;color: white; font-size: 27px; padding-top: 50px;"><img src="<?php echo $PATH_IMG?>dollar.png"/> <b>No website fee</b></p><br/>
		    <ul style="margin-left: 50px;list-style-type: none;">
