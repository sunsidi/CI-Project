...
<head>
<meta charset="utf-8">
<title>Users | Wrevel - Discover Your World, Host & Experience Events</title>
...
<?php echo form_close() ?>
      ...
      if (isset($users_search)){
		...
		<div class="row row-centered" style="margin-top:20px;">
			...
			<?php 
			if (isset($users_search['total_size'])){   // limit the result to 100 users?>
				<p style="text-align:center;font-weight:bold;font-size:26px;"><?php echo $users_search['total_size']?><span style="color:white;"> results found !</span></p>
				<p style="text-align:center;font-weight:bold;font-size:16px; color:black;">There are too many users in the result, we show you the first 100 users.
					<span style="color:white;"> You may need to refine your search ! </span></p>
				<p style="text-align:center;font-weight:bold;font-size:13px; color:black;">Can not find her/him? <a href='https://wrevel.com/info/contactus'>Tell us!</a></p>
			<?php 	}else{
			?>
     ...
     <?php  	while($size_left > 0){
      	    for($j=0; $j < 3 && $size_left != 0; $j++) {   
      	    	

			if($group_page == 1) {?>
					<div class="<?php echo 'event_group'.$group_page?> col-centered col-md-10 col-sm-11 col-xs-12" style="padding-left:3%;">
		<?php 	}else{?>
					<div class="<?php echo 'event_group'.$group_page?> col-centered col-md-10 col-sm-11 col-xs-12" style="padding-left:3%; display: none;" hidden>
		<?php 	}

				for($k=0;$k<4 && $size_left != 0; $k++){
				$size_left--;
      	    	if($group_page == 1) {
      ?>
	      <div class="<?php echo 'event_group'.$group_page?> col-md-3 col-sm-6" style="margin-top:20px;">
	      <?php } else {?>
	      <div class="<?php echo 'event_group'.$group_page?> col-md-3 col-sm-6" style="margin-top:20px;" hidden>
	      <?php }?>
			    ...
			    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none; opacity: 1;padding: 0px 10px;">
	                        <!--Description -->
				<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$users_search[$i]["fullname"];  // limit the user name to 16 characters
				...
				echo $username?></p>
	                        ...
	                        if($users_search[$i]['tagline']){
	                        	echo $users_search[$i]['tagline'];
	                        }else{
	                        	echo 'A good Meetup Group description explains what your Meetup Group is about,who should join, .......';}
	                        ?>
				</p>
				<center><button style="background:#f8f9fb; color: black; border-radius: 5px; font-size:15px; padding: 5px 10px;" onclick="goto_showroom(<?php echo$users_search[$i]['user_id']?>)">Find Out More</button></center>
			    </a>
      
				<div class="mosaic-backdrop" style="display: block; background: #f8f9fb;padding: 10px 20px;">
	                        <?php 
				if($users_search[$i]['business']==0)
				...
				?>
				<center><img class="fb_pic_sb" 
				src="<?php
				if(substr($users_search[$i]['image_key'],0,6)=='//grap'){ //use photo from fb
						echo $users_search[$i]['image_key'];}else{ // use photo from wrevel
				...
				<span style="font-size: 25px; color: black; text-align: center;"><?php 
				$username=$users_search[$i]["fullname"];   // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				...
				<center><i class="fa fa-map-marker"></i>&nbsp;&nbsp;<?php echo $users_search[$i]["location"]?></center>
				</div>
    </div>
              </div>
   ...
   <div class="item active">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none; opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[0]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[0]['image_key'],0,6)=='//grap'){ //have fb connect,use photo from fb
					echo $active_users[0]['image_key'];}else{ //use photo from wrevel account
echo base_url()?>uploads/<?php echo $active_users[0]['image_key'];
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[1]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[1]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[1]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[1]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[2]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[2]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[2]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[2]['image_key'];}else{ // use photo from wrevel account
echo base_url()?>uploads/<?php echo $active_users[2]['image_key'];
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left:30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[3]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[3]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[3]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[3]['image_key'];}else{ // use photo from wrevel account
    ...
    <div class="item">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[4]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[4]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[4]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[4]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[5]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[5]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[5]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[5]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[6]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[6]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[6]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[6]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[7]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[7]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[7]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[7]['image_key'];}else{ // use photo from wrevel account
    ...
    <div class="item">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[8]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[8]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[8]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[8]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[9]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[9]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[9]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[9]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[10]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[10]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[10]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[10]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$active_users[11]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($active_users[11]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($active_users[11]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $active_users[11]['image_key'];}else{ // use photo from wrevel account
   ...
   <div class="item active">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none; opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[0]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[0]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[0]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[0]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[1]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[1]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[1]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[1]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[2]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[2]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[2]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[2]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left:30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[3]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[3]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[3]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[3]['image_key'];}else{ // use photo from wrevel account
    ...
    <div class="item">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[4]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[4]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[4]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[4]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[5]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[5]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[5]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[5]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[6]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[6]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[6]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[6]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[7]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[7]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[7]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[7]['image_key'];}else{ // use photo from wrevel account
    ...
    <div class="item">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[8]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[8]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[8]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[8]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[9]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[9]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php  if(substr($eaner_users[9]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[9]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[10]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[10]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[10]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[10]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$eaner_users[11]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($eaner_users[11]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($eaner_users[11]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $eaner_users[11]['image_key'];}else{ // use photo from wrevel account
   ...
   <div class="item active">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none; opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[0]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[0]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[0]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[0]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[1]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[1]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[1]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[1]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[2]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[2]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[2]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[2]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left:30px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[3]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[3]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[3]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[3]['image_key'];}else{ // use photo from wrevel account
    ...
    <div class="item">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[4]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[4]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[4]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[4]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[5]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[5]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[5]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[5]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[6]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[6]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[6]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[6]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[7]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[7]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[7]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[7]['image_key'];}else{ // use photo from wrevel account
    ...
    <div class="item">
        <div class="container" style="margin-top: -1px; margin-left: 3%;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[8]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[8]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[8]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[8]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[9]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[9]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[9]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[9]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[10]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[10]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="//use photo from fb" src="<?php if(substr($buyer_users[10]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[10]['image_key'];}else{ // use photo from wrevel account
	    ...
	    <div class="col-md-2 col-sm-6 col-xs-12" style="position: relative;width: 230px; height: 255px;margin-left: 25px;">
		    ...
		    <a target="_blank" class="mosaic-overlay" style="display: inline; left: 0px;text-decoration: none;opacity: 1;padding: 0px 10px;">
                        <!--Description -->
			<p style="text-align: center; margin-top: 50px; color: white; font-size:23px;"><?php 
				$username=$buyer_users[11]["fullname"];  // limit the user name to 16 characters
				if(strlen($username)>16){
				$username=substr($username, 0,14)."...";
				}
				echo $username?></p>
			...
			if($buyer_users[11]['business']==0)
				...
				echo'<img src="https://wrevel.com/src/data/img/business_profile_icon.png" style="width:30px;margin-left:90%;">';
			?>
			<center><img class="fb_pic_sb" src="<?php if(substr($buyer_users[11]['image_key'],0,6)=='//grap'){ //use photo from fb
					echo $buyer_users[11]['image_key'];}else{ // use photo from wrevel account
