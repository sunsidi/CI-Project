...
<body>
	<div class="col-md-6 col-md-offset-3" style="padding-top: 40px; padding-bottom: 45px;">
	    ...
	    <p style="text-align: justify;">
		 <span style="font-family:GillSans;">Name</span> <span style="margin-left:100px;"><?php echo $fullname?></span>
	    </p>
             <p style="text-align: justify;">
		 <span style="font-family:GillSans;">Ticket Type</span> <span style="margin-left:60px;"><?php echo $ticket_type?></span>
	    </p>
	      <!--<p style="text-align: justify;">
		 Wrevenue &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;  wrevenue
	    </p>-->
	       <p style="text-align: justify;">
		 <span style="font-family:GillSans;">Event Title</span> <span style="margin-left:67px;"><?php echo $e_name?></span>
	    </p>
		<p style="text-align: justify;">
		<span style="font-family:GillSans;">Ticketing Price</span> <span style="margin-left:38px;"><?php echo '$'.$ticket_price?></span>
	    </p>
	       	<p style="text-align: justify;">
		...
		<span style="font-family:GillSans;">Location</span> <span style="margin-left:84px;">
	    	<?php echo $e_address?></span></br>
	    	<span style="margin-left:152px;"><?php echo $e_city." ";
			echo $e_state." , ".$e_zipcode;
		?></span>
	    </p>
