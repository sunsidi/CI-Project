...
<div class="container" style="padding-bottom:50px;">
    <div class="row" style="margin-top:50px;">
        ...
        <div class="col-md-9 col-md-offset-1">
            ...
            <h2 class="profile-fullname"></h2>
            </div>
			<div class="col-md-1" style="background:#5F929C;height:65px;">$$$$</div> 
            <div class="col-md-3 reputation" style="height:65px;background:#6ca5cc; border-top-right-radius:5px;">
