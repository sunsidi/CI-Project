			...
			<div class="modal fade" id="sign-in" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true" style="height:auto;">
				<div class="modal-dialog" style="height:auto;">
					<div class="modal-content" style="height:auto;">
							...
							<div class="modal-header" style="background-color: #628DA3; height: 80px;">
							<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
							<p style="font-size: 215%; color: white;text-align: center;padding:10px;">
							Welcome to
							...
							<div class="modal-body" style="text-align:left;background:#C2D2DC;">
								...
								<a href="#">
									<button type="submit" class="btn btn-lg pull-right" style="background:#00aade; color:white; font-size:18px; margin-top:5px; margin-left: 20px;position:absolute">Sign in</button>
								</a>
...
<div style="margin:0 20px;">
	<div class="col-md-4 col-sm-4 col-xs-4">
		<a href="<?php echo base_url()."main/get_related_events/culture"?>"><div class="panel" style="background-image:url(<?php echo $PATH_IMG?>culture1.png);-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover;  color:white; text-align:center; border:2px solid #3F4553; padding:20px 50px;border-radius:15px;height:587px;">
	...
	<div class="col-md-4 col-sm-4 col-xs-4">
		<a href="<?php echo base_url()."main/get_related_events/hotspots"?>"><div class="panel" style="background-image:url(<?php echo $PATH_IMG?>hotspots1.png);-webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover;color:white; text-align:center; padding:20px 50px;border-radius:15px;height:587px; border:2px solid #3F4553;">
			<div class="panel-body">
    ...
    <div class="col-md-12" style="padding-left: 100px;">
     	<p style="color: white; text-align: center; font-size: 52px; font-family:'Lobster';text-decoration:underline;">How It Works</p>
		<div class="col-md-4 col-md-offset-1">
			<p style="font-size: 45px; color: white; margin-top:45px;"><strong>Find an event</strong></p>
			<p style="font-size: 25px; color: white;">Find events with much more ease.<br/>
	    Everything is simply categorized for<br/>
	    all types of events; whether you&rsquo;re<br/>
	    looking for house parties or clubs<br/>
	    we have it all.
		</div>
		<div class="col-md-6">
    ...
    <div class="col-md-12">
		<div class="col-md-5 col-md-offset-1">
			<img src="<?php echo $PATH_IMG?>samantha.png" />
		</div>
		<div class="col-md-5">
			<p style="font-size: 45px; color: white; padding-top: 100px;font-center;"><strong>Create an event</strong></p>
			<p style="font-size: 25px; color: white; padding-bottom: 50px;">If you cannot find the event of your<br/>
	    choice, <b>create it</b>! Have fun experimenting<br/>
	    and make it public for others to attend.<br/>
	    You can even <b>customize your own tickets</b><br/>
	    for the events you make.</p>
		</div>
    </div>
      
    <div class="col-md-12" style="background:#A5B9CB; padding:25px 0;">
